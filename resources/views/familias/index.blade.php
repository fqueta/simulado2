...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12 text-right mb-3">
      <a href="{{ route('familias.create') }}" class="btn btn-success"> <i class="fa fa-plus" aria-hidden="true"></i> Nova familia </a>
    </div>
    <div class="col-md-12">
      <div class="card">
        <div class="card-header"><h5>Lista de famílias cadastradas</h5></div>
        <div class="card-body">
              ...
              <tbody>
                @if(isset($familias))
                    ...
                    <tr>
                        ...
                        <a href="{{ route('familias.index') }}?fil[inativo]=t&fil[id_familia]={{$familia->id}}" class="btn btn-primary" title="Publicadores do familia"><i class="fa fa-users"></i></a>
